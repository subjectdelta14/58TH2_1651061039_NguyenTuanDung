  ...
  <div class="col-md-12 text-center">
    <div class="card">
      <div class="card-header">
        <h5 class="card-title">Tạo vật liệu</h5>
      </div>
      <div class="card-body">
        <form>
...
export default {
  data: function () {
    return {
      ...
      txtNameProduct: false,
      txtTypeProduct: false,

      txtPriceProduct: false,
      txtNumbProduct: false,
      txtYearProduct: false,
      txtImgProduct: false,
      txtDescribeProduct: false,
      txtLocationProduct: false,
      txtImpactProduct: false,
    };
  },
  components: {},
  methods: {
    ...
    convertBase64UrlToBlob(urlData) {
      var binary_string = window.atob(urlData.split(",")[1]);
    ...
    createProduct() {
      ...
      if (self.nameProduct == "") {
        ...
        ApiFunction("qlvl/", "POST", productModel);
      }
    },
  },
