...
export default {
  ...
  methods: {
    ...
    async getProduct() {
      this.oneProduct = await ApiFunction("qlvl/customer/get/" + this.id, "GET", null);
    ...
    createProduct() {
      let self = this;
      if (self.name == "") {
        alert("Tên khách  không được để trống");
      } else if (self.email == "") {
        alert(" Email không được để trống ");
      } else if (self.phone == "") {
        alert(" Điện thoại khách hàng không được để trống ");
      }else if (self.adress == "") {
        ...
        ApiFunction("qlvl/customer/updates/"+this.id, "POST", newsModel);
      }
    },
  },
  created() {
